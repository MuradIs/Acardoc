...
public class UIHud {
    ...
    public UIHud(GameMain game){
        ...
        scoreTable.add(scoreImage).padRight(20).padBottom(15);
        scoreTable.row();
        scoreTable.add(scoreLabel).padRight(10).padBottom(15);
    ...
    void createButtons(){
        ...
        pauseBtn.setPosition(470,800, Align.topRight);
